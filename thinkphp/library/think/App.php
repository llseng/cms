...
class App extends Container
{
    ...
    public function initialize()
    {
        ...
        $this->runtimePath = $this->rootPath . 'Cencms' . DIRECTORY_SEPARATOR . 'runtime' . DIRECTORY_SEPARATOR;
        $this->routePath   = $this->rootPath . 'Cencms' . DIRECTORY_SEPARATOR . 'route' . DIRECTORY_SEPARATOR;
        $this->configPath  = $this->rootPath . 'Cencms' . DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR;
    ...
    public function getAppPath()
    {
        if (is_null($this->appPath)) {
            $this->appPath = Loader::getRootPath() . 'Cen' . DIRECTORY_SEPARATOR;
        }
